  ...
  Widget build(BuildContext context) {
    return new Stack(
      ...
      children: <Widget>[
        ...
        new CustomPaint(
          painter: new WhiteCircleCutoutPanter(
...
class WhiteCircleCutoutPanter extends CustomPainter {
  ...
  WhiteCircleCutoutPanter({
    this.circles = const [],
    this.centerOffset = const Offset(0.0, 0.0),
  })  : whitePaint = new Paint(),
        borderPaint = new Paint() {
    borderPaint.color = const Color(0x10FFFFFF);
    borderPaint.style = PaintingStyle.stroke;
    borderPaint.strokeWidth = 3.0;
  }

  /// Uses the alpha of the one before it to get the "ring" effect.
  @override
  ...
  _maskCircle(Canvas canvas, Size size, double radius) {
    ...
    canvas.clipPath(
        clippedCircle); // Clipping tells you where you're allowed to paint, instead of where you're not allowed. Paint anywhere on the screen except the circle we've cut out.
  }
